...
nb00 = [
    ...
    md(
        ...
        "המחברות שלהלן מכסות לעומק את שני המערכים שכן נכללים בו, עם נגיעות במושגים מההרצאות האחרות ",
        "(שיוך נתונים, fusion ברמה גבוהה) במקומות שבהם Blasch מתייחס אליהם.",
    ),
    md(
        "## דרישות הרצה",
        "",
